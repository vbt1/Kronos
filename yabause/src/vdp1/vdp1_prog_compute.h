...
"  while ((cmdindex != -1) && (newColor == vec4(0.0)) && (idCmd<nbCmd[lindex]) ) {\n"
...
"      newColor.b = float((int(newColor.b*255.0)&0xF8)|mode)/255.0; \n"
"    }\n"
"    if (newColor != vec4(0.0)) finalColor = newColor;\n"
"  }\n"
#ifdef SHOW_QUAD
